...
Tasks.propTypes = {
  task: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.isRequired
};
...
throw new Error("Module build failed: SyntaxError: JSX value should be either an expression or a quoted JSX text (9:23)\n\n   7 |         {this.props.tasks.map(function (task) {\n   8 |           return (\n>  9 |             <Task task=task />\n     |                        ^\n  10 |           )\n  11 |         })}\n  12 |       </div>\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-9ccdc061257523499259.js.map
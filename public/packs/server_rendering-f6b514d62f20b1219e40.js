...
throw new Error("Module build failed: SyntaxError: Unexpected token (6:7)\n\n  4 |   render() {\n  5 |     return (\n> 6 |       <%= picture_for(current_user) %>\n    |        ^\n  7 |       <h3><%= current_user.name %>s ToDo List</h3>\n  8 |       <%= react_component(\"Title\", {name: current_user.name, count: current_user.tasks.count{|t|t.completed==false}})%>\n  9 |     )\n");
  ...
  _createClass(Task, [{
    ...
    value: function render() {
      if (!this.props.task.completed) {
        var href = "/tasks/" + this.props.task.id;
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "div",
          null,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Profile__ = __webpack_require__(/*! ./Profile */ 13);
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-f6b514d62f20b1219e40.js.map
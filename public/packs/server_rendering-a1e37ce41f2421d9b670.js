...
throw new Error("Module build failed: SyntaxError: this is a reserved word (31:7)\n\n  29 |   render() {\n  30 |     return (\n> 31 |       {this.state.img_tag}\n     |        ^\n  32 |       <h3>{this.state.name}s ToDo List</h3>\n  33 |       <%= react_component(\"Title\", {name: current_user.name, count: this.state.count})%>\n  34 |     )\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-a1e37ce41f2421d9b670.js.map